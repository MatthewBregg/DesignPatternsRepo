...
(let heartSuite (clone suite))
(set-family heartSuite heartFamily)

(let diamondSuite (clone suite))
(set-family diamondSuite diamondFamily)

(let clubSuite (clone suite))
(set-family clubSuite clubFamily)

(let spadeSuite (clone suite))
(set-family spadeSuite spadeFamily)
