...
(define backgroundLayout 
  (layout 
  (leaf-layout whiteRectangle wholeCard)
  (leaf-layout "suite" topRightCorner)
  (leaf-layout "suite" bottomLeftCorner))
)

(define jackLayout 
  (layout (leaf-layout backGroundLayout wholeCard)
  (leaf-layout J topRightCorner)
  (leaf-layout J bottomLeftCorner)
  (leaf-layout jackImage center))
)

(define queenLayout 
  (layout (leaf-layout backGroundLayout wholeCard)
  (leaf-layout Q topRightCorner)
  (leaf-layout Q bottomLeftCorner)
  (leaf-layout queenImage center))
)

(define kingLayout 
  (layout (leaf-layout backGroundLayout wholeCard)
  (leaf-layout K topRightCorner)
  (leaf-layout K bottomLeftCorner)
  (leaf-layout kingImage center))
)

(define KingCard 
  (card ("King" kingLayout kingLayout))
)

(define JackCard 
  (card ("Jack" JackLayout JackLayout))
)

(define QueenCard 
  (card ("Queen" QueenLayout QueenLayout))
)

(define oneLayout
  (layout (leaf-layout backGroundLayout wholeCard)
  (leaf-layout one topRightCorner)
  (leaf-layout one topLeftCorner)
  (leaf-layout "suite" center)
)

(define oneCard (card "One" oneLayout oneLayout))
...

(define tenLayout
  (layout (leaf-layout backGroundLayout wholeCard)
  (leaf-layout ten topRightCorner)
  (leaf-layout ten topLeftCorner)
  (leaf-layout "suite" center-10-1)
  (leaf-layout "suite" center-10-2)
  (leaf-layout "suite" center-10-3)
  (leaf-layout "suite" center-10-4)
  (leaf-layout "suite" center-10-5)
  (leaf-layout "suite" center-10-6)
  (leaf-layout "suite" center-10-7)
  (leaf-layout "suite" center-10-8)
  (leaf-layout "suite" center-10-9)
  (leaf-layout "suite" center-10-10)
)

(define tenCard (card "Ten" tenLayout tenLayout))
