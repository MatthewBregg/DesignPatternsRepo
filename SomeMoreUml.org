...
note top : Just returns assembler.getMap().get(varname);
...
Token : getBuilder(Assembler assembler):Builder
class VariableToken
...
ParseErrorToken : getBuilder(Assembler assembler): ErrorBuilderVisiter
AtomToken : getBuilder(Assembler assembler): ConstantBuilderVisiter
VariableToken : getBuilder(Assembler assembler): VariableBuilderVisiter
