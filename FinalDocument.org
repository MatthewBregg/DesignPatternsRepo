...
*** Factory Method
**** Why we used?
\newline Each non decorating, and non dynamic decal has a specific visiter which it must make. The super is the client. 
**** What we gained?
...
\newline If we add a new shape, all visiters need be updated.
...
***** What we gained?
\newline Decal don't care about what shape they are told to render in, just make their visiter, and have the visiter visit and render in that shape. 
***** Consequences
\newline A visiter for each DecalWithFM implementor.
