...
Note : This will include the ScriptObject, and everything inheriting from it.
Note : Changing layouts to this.
This covers
- Layouts
- ScriptObject
  - Size,family, etc...
...
A fairly simple class, see the UML for decals.
If a new langauge were to be added, perhaps the Lexer would become abstract, and have concrete Lexers implementing it. But we are only caring about support one scripting langauge. 
