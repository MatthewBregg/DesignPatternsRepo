...
State : addString(name:String,fb:FamilyBuilder)
State : addDecal(value:Decal,fb:FamilyBuilder)
State : receivedPair(fb:FamilyBuilder)
State : finishedPair(fb:FamilyBuilder)
