...
note top : clone will deep copy everything, except the ScriptEvaluator. Subclasses when overriding will call super, and thus not deep copy the ScriptEvaluator.
