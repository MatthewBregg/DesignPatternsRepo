...
note top : Clone will deep copy primitives, and collections, but will shallow copy/share most objects.
...
BuilderVisiter <|-- StringConcatBuilder
BuilderNoteS -- StringConcatBuilder

'NumberOperationBuilder
class NumberOperationBuilder
BuilderVisiter <|-- NumberOperationBuilder
BuilderNoteS -- NumberOperationBuilder
